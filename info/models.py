...
class Student(models.Model):
    ...
    name = models.CharField(max_length=200)
    sex = models.CharField(max_length=50, choices=sex_choice, default='Masculino')
        ...
        if hasattr(instance, 'name'):
            ...
            for ass in ass_list:
                try:
                    ...
                    sc.save()
                    sc.marks_set.create(name='Evento 1')
                    sc.marks_set.create(name='Evento 2')
                    sc.marks_set.create(name='Avaliação')
